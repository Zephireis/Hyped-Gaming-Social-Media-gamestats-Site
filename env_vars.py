...
db_host = "s1.swapdns.com"
db_database = "division_flaskdatabase"


#===========================================================================================================#

#in order for creds() to be used we have to pass in the parameters (arguments) in order.)
...
#     database=user_database #user_database will be 4th creds(arg1,arg2,arg3,arg4)
#     )
